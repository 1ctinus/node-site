...
function search() {
  ...
  if (finalString.startsWith("title")) {
    document.getElementById("svga").innerHTML = res[1]; document.getElementById("svgb").innerHTML = res[1]; document.getElementById("svgc").innerHTML = res[1]
  }
}
